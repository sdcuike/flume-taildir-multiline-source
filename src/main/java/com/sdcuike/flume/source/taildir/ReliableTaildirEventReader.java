...
public class ReliableTaildirEventReader implements ReliableEventReader {
    ...
    private ReliableTaildirEventReader(Map<String, String> filePaths,
                                       ...
                                       boolean annotateFileName, String fileNameHeader,String regex) throws IOException {
        // Sanity checks
    ...
    public List<Event> readEvents(int numEvents, boolean backoffWithoutNL)
        ...
        List<Event> events = currentFile.readEvents(numEvents, backoffWithoutNL, addByteOffset,regex);
        if (events.isEmpty()) {
            return events;
        }
    ...
    public static class Builder {
        ...
        public ReliableTaildirEventReader build() throws IOException {
            return new ReliableTaildirEventReader(filePaths, headerTable, positionFilePath, skipToEnd,
                    ...
                    annotateFileName, fileNameHeader,regex);
        }
    }
